   ...
   d_font_size(8), d_first_time(true), d_template_buffer(0)
{
   ...
   Set_dialog_style(WS_CAPTION | WS_VISIBLE | WS_DLGFRAME | WS_POPUP
                          | DS_MODALFRAME | DS_SETFONT | WS_SYSMENU);
...
unsigned int Dynamic_dialog::Add_edit_control(const char* prompt_str,
                                           int prompt_left,
                                           const char* unit_str,
                                           int left, int top,
                                           int width, int height,
                                           ...
                                           WORD id)
{
   if (!Add_prompt_and_unit_strings(prompt_str, prompt_left,
      ...
      Dialog_item item;
      item.Define_edit_control(id, left, top, width, height, str,
                               max_length);
